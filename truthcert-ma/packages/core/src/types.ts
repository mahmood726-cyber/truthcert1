...
export interface HookPayloads {
  'before:analyze': { studies: Study[] };
  'after:analyze': { result: MetaAnalysisResult };
  'before:pool': { effects: EffectSizeResult[] };
  'after:pool': { pooled: PooledResult };
  'effect-size:register': { name: string };
  'estimator:register': { name: Tau2Estimator };
  'output:register': { format: string };
  'parser:register': { format: string };
}
