        # Truthcert1: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/truthcert1.git

        ## Objective

        TruthCert v1 is the foundational TruthCert evidence certification framework implementing proof-carrying numbers with hash-linked evidence locators and validator receipts.
        ...
        - Code: https://github.com/mahmood726-cyber/truthcert1.git
