...
| Test Case | Description | DeltaCost | DeltaQALY | Expected ICER |
|-----------|-------------|-----------|-----------|---------------|
...
|--------|-----------|-------------|-------|------------|
| DeltaCost | $5,000 | $5,000 | $5,000 | 0% |
| DeltaQALY | 0.5 | 0.5 | 0.5 | 0% |
...
- QALY gain: 0.040 x 0.15 x 11.2 years = 0.067

**Results:**

| Metric | TruthCert | TreeAge Pro | Excel | Difference |
|--------|-----------|-------------|-------|------------|
| DeltaCost | $2,500 | $2,500 | $2,500 | 0% |
| DeltaQALY | 0.0670 | 0.0670 | 0.0671 | 0.15% |
...
|--------|-----------|-------------|------------|
| DeltaCost (mean) | $8,000 | $8,000 | 0% |
| DeltaQALY (mean) | 0.094 | 0.094 | 0% |
...
### 3.1 Dominant Intervention (DeltaCost < 0, DeltaQALY > 0)

**Inputs:**
- DeltaCost: -$1,000 (intervention saves money)
- DeltaQALY: 0.2 (intervention improves health)
...
### 3.2 Dominated Intervention (DeltaCost > 0, DeltaQALY < 0)

**Inputs:**
- DeltaCost: $5,000 (intervention costs more)
- DeltaQALY: -0.1 (intervention worsens health)
...
### 3.3 Indeterminate (DeltaQALY approximately 0)
...
| Software | Output |
|----------|--------|
| TruthCert | "ICER unstable (DeltaQALY approximately 0)" with warning |
...
EVPI calculated as:
```
EVPI = E[max(NMB1, NMB2)] - max(E[NMB1], E[NMB2])
```
